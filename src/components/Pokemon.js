...
//   const [ pokeImage, setPokeImage ] = useState('');
//   const [ pokeSpecDetails, setPokeSpecDetails ] = useState({});
//   const [ pokeDetails, setPokeDetails ] = useState({
//     name: '',
//     pIndex: '',
//     pImgUrl: '',
...
//   let { pokemonIndex } = useParams();
//   let { description, hp, attack, defense, speed, specialAttack, specialDefense } = '';
...
//     const pokemonUrl = axios(`https://pokeapi.co/api/v2/pokemon/${pokemonIndex}/`); 
//     const pokemonSpeciesUrl = axios(`https://pokeapi.co/api/v2/pokemon-species/${pokemonIndex}/`);
...
//         setPokeSpecDetails({ ...pokeSpecDetails, description })
...
//   const { name, pImgUrl, types, height, weight, stats } = pokeDetails;
//   // const { name, pImgUrl, types, height, weight, stats } = data;
...
//           <h6> HP: { stats.hp} </h6>
//           <h6> ATTACK: { stats.attack} </h6>
//           <h6> DEFENSE: { stats.defense} </h6>
//           <h6> SPEED: { pokeDetails.stats.speed} </h6>
//           <h6> SPECIAL ATTACK: { pokeDetails.stats.specialAttack} </h6>
//           <h6> SPECIAL DEFENSE: { pokeDetails.stats.specialDefense} </h6>
//         </div>
//         <img src={ pImgUrl } height='300px' width='20%' />
//         <div>
//         <h1> 
//           Types:
//           { types.length > 0 ? pokeDetails.types.map(( type, index ) => <p key={index}> { type } </p> ) : pokeDetails.types[0]}
//         </h1>
//         </div>
//       </div>
//       <div>
...
//             setSpeciesData({ ...speciesData, description })
...
//       <div className='poke-wrap'>
//         <div>
//           <h6> Height: { pokeDetails.height} ft </h6>
//           <h6> Weight: { pokeDetails.weight} lbs</h6>
//           <h6> HP: { pokeDetails.stats.hp} </h6>
//           <h6> ATTACK: { pokeDetails.stats.attack} </h6>
//           <h6> DEFENSE: { pokeDetails.stats.defense} </h6>
//           <h6> SPEED: { pokeDetails.stats.speed} </h6>
//           <h6> SPECIAL ATTACK: { pokeDetails.stats.specialAttack} </h6>
//           <h6> SPECIAL DEFENSE: { pokeDetails.stats.specialDefense} </h6>
//         </div>
//         <img src={ pokeImage } height='300px' width='20%' />
//         <div>
//         <h1> 
//           Types:
//           { pokeDetails.types.length > 0 ? pokeDetails.types.map(( type, index ) => <p key={index}> { type } </p> ) : pokeDetails.types[0]}
//         </h1>
//         </div>
//       </div>
//       <div>
...
//   const pokemonUrl = `https://pokeapi.co/api/v2/pokemon/${pokemonIndex}/`; 
//   const pokemonRes = axios.get(pokemonUrl).then( res => res.data);
  
//   useEffect(() => {
    
//     setPokeId(pokemonIndex);
//     setResult(pokemonRes);
...
// function Pokemon({ pokemon, url, id, name, image, type }) {
...
//       </h6>
//       <h1> { pokemonIndex } </h1>
//       {/* <img src={`https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/${pokemonIndex}/1.png`} /> */}
//       <img src={`https://github.com/PokeAPI/sprites/blob/master/sprites/pokemon/${pokemonIndex}.png?raw=true`} />
//     </div>
//   );
// }
